...
class _yearState extends State<year> {
  ...
  String likeurl = 'http://uni-social.tk/api/v1/like';
  ...
  Future<String> likemakeRequest() async {

    var response = await http
        .get(Uri.encodeFull(likeurl), headers: {"Accept": "application/json"});

    setState(() {
      var extractdata = json.decode(response.body);
      likedata = extractdata["data"];
    });
  }
  ...
  addlike()async{
    ...
    await http.post("http://uni-social.tk/api/v1/like/add",body:{
      "like": "true",
      "user_id": "1",
      "post_id" :"29"
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder:(BuildContext context, i){
          ...
          return data[i]["status"] == 0 ? null : Card(
