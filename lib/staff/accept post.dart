  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("posts",style: TextStyle(color: Colors.black, fontSize: 15.0),),
        centerTitle: true,
      ),
      body: RefreshIndicator(
        ...
        child: ListView.builder(
          ...
          itemBuilder:(BuildContext context, i){
            ...
            return data[i]["status"] == 1 ? Text("") : Card(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                                RaisedButton(
                                  color: Colors.green,
                                  child: Text("Accept"),
                                  onPressed:()=> acceptPost(data[i]['id'],data[i]['user_id'],data[i]['content']),
                                ),
                                RaisedButton(
                                  color: Colors.red,
                                  child: Text("Reject"),
                                  onPressed:()=> deleteRejected(data[i]['id']),
                                ),
                          ],
                        ),
                      )
